...
void Pawn::getAllPossibleMoves(std::pair<char, int> currentPosition) {
    ...
    if (this->inStartingPosition) {
        if (this->color == 'w') {
            std::pair<char, int> newMove = std::make_pair(
                currentPosition.first, currentPosition.second + 2);
    ...
    if (this->color == 'w') {
        ...
        std::pair<char, int> diagonalOne = std::make_pair(
            currentPosition.first + 1, currentPosition.second + 1);
        ...
        std::pair<char, int> diagonalTwo = std::make_pair(
            currentPosition.first - 1, currentPosition.second + 1);
