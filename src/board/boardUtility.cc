...
//  to the corresponding number ranging from 0 to 7.
// requires:
...
//  to the corresponding character ranging from a to h.
// requires:
...
//  of corresponding type. It returns a pointer to the newly created piece.
// Requires:
